...
SOURCE_DIR = "raw_melanoma"

TRAIN_DIR = "train/melanoma"
VAL_DIR = "val/melanoma"
...
folder_map = {
    "melanoma_benign": "benign",
    "melanoma_malignant": "malignant"
}
...
print("✅ Melanoma data split completed!")
